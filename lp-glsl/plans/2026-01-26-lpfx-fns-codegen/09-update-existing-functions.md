...
2. Update simplex functions:
   - Add `#[lpfx_impl(f32, "float lpfx_simplex1(float x, u32 seed)")]` to f32 implementations
   - Add `#[lpfx_impl(q32, "float lpfx_simplex1(float x, u32 seed)")]` to q32 implementations
