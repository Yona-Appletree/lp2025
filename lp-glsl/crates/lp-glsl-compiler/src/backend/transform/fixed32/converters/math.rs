...
pub fn map_testcase_to_builtin(testcase_name: &str) -> Option<(BuiltinId, usize)> {
    match testcase_name {
        ...
        "lp_simplex1f" | "__lp_lp_simplex1" => Some((BuiltinId::Fixed32LpSimplex1, 2)),
        "lp_simplex2f" | "__lp_lp_simplex2" => Some((BuiltinId::Fixed32LpSimplex2, 3)),
        "lp_simplex3f" | "__lp_lp_simplex3" => Some((BuiltinId::Fixed32LpSimplex3, 4)),
