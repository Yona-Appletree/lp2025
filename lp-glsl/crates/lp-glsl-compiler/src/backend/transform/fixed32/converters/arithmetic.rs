...
/// Convert Fadd to fixed-point addition by calling __lp_fixed32_add builtin.
pub(crate) fn convert_fadd(
    ...
    // Create signature for __lp_fixed32_add: (i32, i32) -> i32
    ...
    // Call __lp_fixed32_add with the mapped arguments
...
/// Convert Fsub to fixed-point subtraction by calling __lp_fixed32_sub builtin.
pub(crate) fn convert_fsub(
    ...
    // Create signature for __lp_fixed32_sub: (i32, i32) -> i32
    let mut sig = Signature::new(CallConv::SystemV);
    sig.params.push(AbiParam::new(types::I32));
    sig.params.push(AbiParam::new(types::I32));
    sig.returns.push(AbiParam::new(types::I32));
    ...
    // Call __lp_fixed32_sub with the mapped arguments
...
/// Convert Fdiv to fixed-point division by calling __lp_fixed32_div builtin.
pub(crate) fn convert_fdiv(
    ...
    // Create signature for __lp_fixed32_div: (i32, i32) -> i32
    let mut sig = Signature::new(CallConv::SystemV);
    sig.params.push(AbiParam::new(types::I32));
    sig.params.push(AbiParam::new(types::I32));
    sig.returns.push(AbiParam::new(types::I32));
    ...
    // Call __lp_fixed32_div with the mapped arguments
