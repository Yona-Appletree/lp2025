...
// run: test_mat2_subtract_simple() ~= mat2(4.0, 2.0, 2.0, 1.0) [expect-fail]
...
// run: test_mat2_subtract_identity() ~= mat2(1.0, 0.0, 0.0, 1.0) [expect-fail]
...
// run: test_mat2_subtract_negative() ~= mat2(2.0, -4.0, 6.0, -8.0) [expect-fail]
...
// run: test_mat2_subtract_variables() ~= mat2(7.0, 6.0, 5.0, 4.0) [expect-fail]

mat2 test_mat2_subtract_expressions() {
    return mat2(5.0, 4.0, 3.0, 2.0) - mat2(2.0, 1.0, 2.0, 1.0);
}

// run: test_mat2_subtract_expressions() ~= mat2(3.0, 3.0, 1.0, 1.0) [expect-fail]
...
// run: test_mat2_subtract_in_assignment() ~= mat2(9.0, 6.0, 3.0, 0.0) [expect-fail]
...
// run: test_mat2_subtract_large_values() ~= mat2(500.0, 1000.0, 1500.0, 2000.0) [expect-fail]
...
// run: test_mat2_subtract_zero_matrix() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]
