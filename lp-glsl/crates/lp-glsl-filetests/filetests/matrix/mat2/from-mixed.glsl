...
// run: test_mat2_from_vec2_scalar_scalar() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_scalar_vec2_scalar() {
    return mat2(1.0, vec2(2.0, 3.0), 4.0);
}

// run: test_mat2_from_scalar_vec2_scalar() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_scalar_scalar_vec2() {
    return mat2(1.0, 2.0, vec2(3.0, 4.0));
}

// run: test_mat2_from_scalar_scalar_vec2() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_multiple_scalars() {
    return mat2(1.0, 2.0, 3.0, 4.0);
}

// run: test_mat2_from_multiple_scalars() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_mixed_expressions() {
    return mat2(vec2(1.0, 2.0) + vec2(0.5, 0.5), 3.0 * 2.0, 4.0 + 1.0);
}

// run: test_mat2_from_mixed_expressions() ~= mat2(1.5, 2.5, 6.0, 5.0) [expect-fail]
...
// run: test_mat2_from_mixed_variables() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_mixed_negative() {
    return mat2(vec2(-1.0, -2.0), -3.0, -4.0);
}

// run: test_mat2_from_mixed_negative() ~= mat2(-1.0, -2.0, -3.0, -4.0) [expect-fail]

mat2 test_mat2_from_mixed_zero() {
    return mat2(vec2(0.0, 0.0), 0.0, 0.0);
}

// run: test_mat2_from_mixed_zero() ~= mat2(0.0, 0.0, 0.0, 0.0) [expect-fail]
...
// run: test_mat2_from_mixed_in_assignment() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]
