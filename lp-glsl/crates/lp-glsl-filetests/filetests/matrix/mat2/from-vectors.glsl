...
// run: test_mat2_from_vec2_columns() ~= mat2(1.0, 2.0, 3.0, 4.0) [expect-fail]

mat2 test_mat2_from_vec2_expressions() {
    return mat2(vec2(1.0, 2.0) + vec2(0.5, 0.5), vec2(3.0, 4.0) * vec2(1.0, 1.0));
}

// run: test_mat2_from_vec2_expressions() ~= mat2(1.5, 2.5, 3.0, 4.0) [expect-fail]
...
// run: test_mat2_from_vec2_variables() ~= mat2(5.0, 6.0, 7.0, 8.0) [expect-fail]
...
// run: test_mat2_from_vec2_identity() ~= mat2(1.0, 0.0, 0.0, 1.0) [expect-fail]
...
// run: test_mat2_from_vec2_zero() ~= mat2(0.0, 0.0, 0.0, 0.0) [expect-fail]

mat2 test_mat2_from_vec2_negative() {
    return mat2(vec2(-1.0, -2.0), vec2(-3.0, -4.0));
}

// run: test_mat2_from_vec2_negative() ~= mat2(-1.0, -2.0, -3.0, -4.0) [expect-fail]
...
// run: test_mat2_from_vec2_mixed() ~= mat2(1.0, -2.0, 3.5, 4.5) [expect-fail]
...
// run: test_mat2_from_vec2_in_assignment() ~= mat2(2.0, 3.0, 4.0, 5.0) [expect-fail]

mat2 test_mat2_from_vec2_function_result() {
    return mat2(normalize(vec2(3.0, 4.0)), vec2(1.0, 0.0));
}

// run: test_mat2_from_vec2_function_result() ~= mat2(0.6, 0.8, 1.0, 0.0) [expect-fail]
