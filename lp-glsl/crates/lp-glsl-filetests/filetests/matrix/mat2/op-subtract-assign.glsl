...
// run: test_mat2_subtract_assign_simple() ~= mat2(4.0, 2.0, 2.0, 1.0) [expect-fail]
...
// run: test_mat2_subtract_assign_identity() ~= mat2(1.0, 0.0, 0.0, 1.0) [expect-fail]
...
// run: test_mat2_subtract_assign_variables() ~= mat2(7.0, 6.0, 5.0, 4.0) [expect-fail]
...
// run: test_mat2_subtract_assign_expressions() ~= mat2(4.0, 4.0, 2.0, 2.0) [expect-fail]
...
// run: test_mat2_subtract_assign_zero() ~= mat2(5.0, 6.0, 7.0, 8.0) [expect-fail]
...
// run: test_mat2_subtract_assign_negative() ~= mat2(2.0, -4.0, 6.0, -8.0) [expect-fail]
...
// run: test_mat2_subtract_assign_chained() ~= mat2(-4.0, -4.0, -4.0, -4.0) [expect-fail]
...
// run: test_mat2_subtract_assign_large_values() ~= mat2(500.0, 1000.0, 1500.0, 2000.0) [expect-fail]
