...
#[unsafe(no_mangle)]
pub extern "C" fn __lpfx_simplex3_float(x: f32, y: f32, z: f32, seed: u32) -> f32 {
    ...
    let result_fixed = __lpfx_simplex3_q32(x_q32.to_fixed(), y_q32.to_fixed(), z_q32.to_fixed(), seed);
