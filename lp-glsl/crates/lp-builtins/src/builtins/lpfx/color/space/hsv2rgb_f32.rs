...
#[unsafe(no_mangle)]
pub extern "C" fn __lpfx_hsv2rgb_f32(x: f32, y: f32, z: f32) -> f32 {
    ...
    let result_fixed = __lpfx_hsv2rgb_q32(x_q32.to_fixed(), y_q32.to_fixed(), z_q32.to_fixed());
...
#[unsafe(no_mangle)]
pub extern "C" fn __lpfx_hsv2rgb_vec4_f32(x: f32, y: f32, z: f32, w: f32) -> f32 {
    // Stub: convert to q32, call q32 version, convert back
    let x_q32 = Q32::from_f32(x);
    let y_q32 = Q32::from_f32(y);
    let z_q32 = Q32::from_f32(z);
    let w_q32 = Q32::from_f32(w);
    let result_fixed = __lpfx_hsv2rgb_vec4_q32(
        x_q32.to_fixed(),
        y_q32.to_fixed(),
        z_q32.to_fixed(),
        w_q32.to_fixed(),
